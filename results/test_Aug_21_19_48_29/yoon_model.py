...
def high2low_test():
    ...
    cv2.imwrite("X_image.png", Xim * 255)  # Save the input image
    cv2.imwrite("Y_image.png", Yim * 255)  # Save the output image
    print("Images saved as X_image.png and Y_image.png.")
